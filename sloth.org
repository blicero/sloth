...
# Time-stamp: <2025-04-09 22:27:48 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-04-09 Mi 22:27]
   | Headline                               | Time      |         |       |      |
   |----------------------------------------+-----------+---------+-------+------|
   | *Total time*                           | *1d 0:44* |         |       |      |
   |----------------------------------------+-----------+---------+-------+------|
...
*** TODO Fused refresh-upgrade
    ...
    away, in one command.
*** TODO Check if package cache is up to date
